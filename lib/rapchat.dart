...
class rapchat extends StatefulWidget {
  const rapchat({Key? key}) : super(key: key);

  @override
  State<rapchat> createState() => _rapchatState();
}

class _rapchatState extends State<rapchat> {
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
          image: DecorationImage(image: AssetImage("img/telebackground.jpg"),fit: BoxFit.fill)),
      child: Scaffold(
